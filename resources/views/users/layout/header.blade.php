<header>
    <div class="container">
        <div class="header-data">
            <div class="logo">
                <a href="index-2.html" title=""><img src="{{asset('static/workwise/images/logo.png')}}" alt=""></a>
            </div><!--logo end-->
                ...
                <ul>
                    ...
                    <li>
                        <a href="companies.html" title="">
                            <span><img src="{{asset('static/workwise/images/icon2.png')}}" alt=""></span>
                            Companies
                        </a>
                        <ul>
                    ...
                    <li>
                        <a href="projects.html" title="">
                            <span><img src="{{asset('static/workwise/images/icon3.png')}}" alt=""></span>
                            Projects
                        </a>
                    </li>
                    <li>
                        <a href="profiles.html" title="">
                            <span><img src="{{asset('static/workwise/images/icon4.png')}}" alt=""></span>
                            Profiles
                        </a>
                        <ul>
                    ...
                    <li>
                        <a href="jobs.html" title="">
                            <span><img src="{{asset('static/workwise/images/icon5.png')}}" alt=""></span>
                            Jobs
                        </a>
                    </li>
                    <li>
                        <a href="#" title="" class="not-box-openm">
                            <span><img src="{{asset('static/workwise/images/icon6.png')}}" alt=""></span>
                            Messages
                        </a>
