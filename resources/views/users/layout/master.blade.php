...
<div class="wrapper">
 @include('users.layout.header')
        ...
        <div class="main-section">
            <div class="container">
                <div class="main-section-data">
                    <div class="row">
                        @include('users.layout.leftsidebar')
                        <div class="col-lg-6 col-md-8 no-pd">
                            @yield('pageContent')
                        </div>
                        <div class="col-lg-3 pd-right-none no-pd">
                            @include('users.layout.rightsidebar')
                        </div>
                    </div>
    ...
    <div class="chatbox-list">
        <div class="chatbox">
            <div class="chat-mg">
                <a href="#" title=""><img src="{{asset('static/workwise/images/resources/usr-img1.png')}}" alt=""></a>
                <span>2</span>
            </div>
            <div class="conversation-box">
                <div class="con-title mg-3">
                    <div class="chat-user-info">
                        <img src="{{asset('static/workwise/images/resources/us-img1.png')}}" alt="">
        ...
        <div class="chatbox">
            <div class="chat-mg">
                <a href="#" title=""><img src="{{asset('static/workwise/images/resources/usr-img2.png')}}" alt=""></a>
            </div>
            <div class="conversation-box">
                <div class="con-title mg-3">
                    <div class="chat-user-info">
        ...
        <div class="chatbox">
            <div class="chat-mg bx">
                <a href="#" title=""><img src="{{asset('static/workwise/images/chat.png')}}" alt=""></a>
                <span>2</span>
            </div>
            <div class="conversation-box">
                <div class="con-title">
                ...
                <div class="chat-list">
                    <div class="conv-list active">
                        <div class="usrr-pic">
                            <img src="{{asset('static/workwise/images/resources/usy1.png')}}'" alt="">
                            <span class="active-status activee"></span>
                        </div>
                        <div class="usy-info">
                            <h3>John Doe</h3>
                            <span>Lorem ipsum dolor <img src="{{asset('static/workwise/images/smley.png')}}" alt=""></span>
                        </div>
                        <div class="ct-time">
                            <span>1:55 PM</span>
                        </div>
                    ...
                    <div class="conv-list">
                        <div class="usrr-pic">
                            <img src="{{asset('static/workwise/images/resources/usy2.png')}}" alt="">
                        </div>
                        <div class="usy-info">
                            <h3>John Doe</h3>
                            <span>Lorem ipsum dolor <img src="{{asset('static/workwise/images/smley.png')}}" alt=""></span>
                    ...
                    <div class="conv-list">
                        <div class="usrr-pic">
                            <img src="{{asset('static/workwise/images/resources/usy3.png')}}" alt="">
                        </div>
                        <div class="usy-info">
                            <h3>John Doe</h3>
                            <span>Lorem ipsum dolor <img src="{{asset('static/workwise/images/smley.png')}}" alt=""></span>
