    ...
    <div class="sign-in-page">
            ...
            <div class="signin-pop">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="cmp-info">
                            <div class="cm-logo">
                                <img src="{{asset('static/workwise/images/cm-logo.png')}}" alt="">
                                <p>Workwise,  is a global freelancing platform and social networking where businesses and independent professionals connect and collaborate remotely</p>
                            </div><!--cm-logo end-->
                            <img src="{{asset('static/workwise/images/cm-main-img.png')}}" alt="">
                        </div><!--cmp-info end-->
                    </div>
                    <div class="col-lg-6">
                        <div class="login-sec">
        ...
        <div class="footy-sec">
            <div class="container">
                ...
                <p><img src="{{asset('static/workwise/images/copy-icon.png')}}" alt="">Copyright 2019</p>
            </div>
        </div><!--footy-sec end-->
